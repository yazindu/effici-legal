...
By downloading, installing, or using the Effici mobile application ("App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.

These Terms constitute a legally binding agreement between you ("User", "you", or "your") and the operators of Effici ("we", "us", or "our").

---

## 2. Description of Service

Effici is a productivity application that provides:
- Pomodoro timer functionality for focus sessions
- Session tracking and history
- Project and tag management
- Eye health reminders (20-20-20 rule)
- Ambient audio for concentration
...
### 3.1 Eligibility
You must be at least **13 years old** (or **16 in the EU**) to create an account and use Effici.
...
You may only create and maintain one account. Multiple accounts by the same individual are prohibited.
...
### 4.1 Acceptable Use
You agree to use Effici only for lawful purposes and in accordance with these Terms.
...
- ❌ Sell, rent, or sublicense your access to the App
- ❌ Remove or modify any copyright or proprietary notices

### 4.2 Content Guidelines
While Effici allows you to create session descriptions, project names, and tags, you agree:
- Not to include offensive, abusive, or illegal content
- Not to include personal information of others without consent
- Not to use the App to store or transmit malicious content
...
The App, including all content, features, functionality, and underlying code, is owned by us and protected by:
- Copyright laws
- Trademark laws
- Other intellectual property laws

**Our Rights Include**:
- The Effici name and logo
- The user interface design
- The App's source code
- All original graphics and content

### 5.2 Limited License
We grant you a limited, non-exclusive, non-transferable, revocable license to:
- Download and install the App on your personal device
- Use the App for your personal, non-commercial productivity purposes
...
### 5.3 Your Content
You retain all rights to the productivity data you create in Effici (session descriptions, project names, tags). By using the App, you grant us a limited license to:
- Store your data on our servers
- Process your data to provide the service
- Back up your data to prevent loss
- Display your data to you across your devices

**We do not claim ownership of your productivity data.**
...
- We do not issue refunds directly (Google handles all transactions)
- Contact Google Play support for refund requests

### 6.4 Free Trials (If Applicable)
- Free trials may be offered for Premium features
- You can cancel anytime during the trial without charge
- If not cancelled, you will be charged when the trial ends

---

## 7. Advertisements (Free Version)

### 7.1 Ad Display
The free version of Effici displays advertisements powered by Google AdMob.

By using the free version, you agree that:
- Ads may be displayed at various points in the App
- Ad content is provided by third parties (not under our control)
- Ad personalization is based on your advertising ID (you can opt out in device settings)

### 7.2 Third-Party Ad Content
We are not responsible for:
- The content of third-party advertisements
- Products or services advertised
- Any issues arising from clicking on ads

**Click on ads at your own risk.**
...
- Transfer of data to our servers (Supabase)
- Use of data to provide and improve the service
...
### 9.1 Sync Functionality
Effici uses cloud synchronization to keep your data consistent across devices.
...
### 9.2 Sync Limitations
- Sync requires an active internet connection
- Large amounts of data may take time to sync
- Sync may fail if your account is suspended or deleted

### 9.3 Data Conflicts
In case of sync conflicts:
- Most recent changes typically take precedence
- We are not liable for data loss due to sync conflicts
- **Recommendation**: Ensure stable internet connection before making critical changes
...
EFFICI IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO:
...
You agree to indemnify, defend, and hold harmless Effici and its developers from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from:
- Your use of the App
...
**We will attempt to notify you before termination (except for serious violations).**
...
- Sections of these Terms that should survive termination will survive (e.g., indemnification, disclaimers)

---

## 14. Modifications to the App and Terms

### 14.1 App Modifications
We reserve the right to:
- Modify or discontinue features at any time
- Perform maintenance and updates
- Change how the App works

**We will attempt to notify you of significant changes.**
...
**Informal Resolution**: Before filing a claim, you agree to contact us at effici@yasindu.space to attempt to resolve the dispute informally.
...
These Terms, together with our Privacy Policy, constitute the entire agreement between you and us regarding the use of Effici.
...
### 16.4 Assignment
You may not assign or transfer these Terms without our written consent. We may assign these Terms to a successor or affiliate.

### 16.5 No Third-Party Beneficiaries
These Terms do not create any third-party beneficiary rights.

### 16.6 Language
If these Terms are translated into other languages, the English version shall prevail in case of any conflict.
...
**Privacy Officer**: effici@yasindu.space
...
BY USING EFFICI, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTOOD, AND AGREE TO BE BOUND BY THESE TERMS OF SERVICE.
...
© 2026 Effici. All rights reserved.
